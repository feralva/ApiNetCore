...
namespace Data.Migrations
{
    ...
    [Migration("20200924104507_latLongEstablecimiento")]
    partial class latLongEstablecimiento
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data.Entities.EntidadesNoPersistidas.TotalizadoVisitasPorEstado", b =>
                {
                    ...
                    b.ToTable("TotalizadoVisitasPorEstado");
                });
            ...
            modelBuilder.Entity("Data.Entities.Irregularidad", b =>
                {
                    ...
                    b.Property<string>("UrlEvidenciaResultado")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Data.Entities.Pago", b =>
                {
                    ...
                    b.Property<double>("PrecioLicencia")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Data.Entities.Partido", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Data.Entities.PrecioLicencia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("Precio_Licencia");
                });

            modelBuilder.Entity("Data.Entities.Provincia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Data.Entities.TasaConversionTipoLicencia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<double>("RatioConversion")
                        .HasColumnType("float");

                    b.Property<int>("TipoLicenciaDestinoId")
                        .HasColumnName("Tipo_Licencia_Destino_FK")
                        .HasColumnType("int");

                    b.Property<int>("TipoLicenciaOrigenId")
                        .HasColumnName("Tipo_Licencia_Origen_FK")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("TipoLicenciaDestinoId");

                    b.HasIndex("TipoLicenciaOrigenId");

                    b.ToTable("Tasa_Conversion_Licencia");
                });
            ...
            modelBuilder.Entity("Data.Entities.TipoLicencia", b =>
                {
                    ...
                    b.Property<int>("Cantidad_Maxima_Usuarios")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Data.Entities.Direccion", b =>
                {
                    b.HasOne("Data.Entities.Partido", "Partido")
                        .WithMany()
            ...
            modelBuilder.Entity("Data.Entities.Partido", b =>
                {
                    b.HasOne("Data.Entities.Provincia", "Provincia")
                        .WithMany("Partidos")
            ...
            modelBuilder.Entity("Data.Entities.TasaConversionTipoLicencia", b =>
                {
                    b.HasOne("Data.Entities.TipoLicencia", "TipoLicenciaDestino")
                        .WithMany()
                        .HasForeignKey("TipoLicenciaDestinoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Data.Entities.TipoLicencia", "TipoLicenciaOrigen")
                        .WithMany()
                        .HasForeignKey("TipoLicenciaOrigenId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
